export default function ShortcutsPanel({ open, onClose }) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 max-md:bottom-[76px] left-1/2 -translate-x-1/2 z-[1001] w-[90%] max-w-[400px] rounded-[var(--radius-card)] border border-[var(--color-border)] p-5 animate-[fadeSlideUp_0.2s_ease]"

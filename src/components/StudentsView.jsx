          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[15px] font-medium leading-tight truncate">{esc(s.name)}</div>
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className={`font-bold text-sm tabular-nums ${gpaColor}`}>{s.gpa.toFixed(2)}</span>
                </div>
              </div>
              ...
              {list.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-3 align-middle hidden md:table-cell"><span className="font-mono text-xs text-[var(--color-text-muted)]">{esc(s.studentId)}</span></td>
                    <td className="p-3 align-middle hidden md:table-cell"><span className="text-xs text-[var(--color-text-muted)]">{esc(s.email)}</span></td>
                    <td className="p-3 align-middle">
                    ...
                    <td className="p-3 align-middle">
                      <div className="flex gap-1" onClick={(e) => e.stopPropagation()}>
                        <button onClick={() => onEdit(s.id)} className="w-7 h-7 rounded-lg flex items-center justify-center text-xs text-[var(--color-text-muted)] hover:bg-[var(--color-primary-glow)] hover:text-[var(--color-primary-light)] transition-all">
                          <i className="fa-solid fa-pen-to-square" />
                        </button>
                        <button onClick={() => onDelete(s.id)} className="w-7 h-7 rounded-lg flex items-center justify-center text-xs text-[var(--color-text-muted)] hover:bg-[rgba(248,113,113,0.15)] hover:text-[var(--color-danger)] transition-all">
                          <i className="fa-solid fa-trash-can" />
                        </button>
                      </div>
                    </td>
